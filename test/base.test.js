...
test['construct URLs'] = {
  ...
  'default language': function() {
    ...
    expect(urls).to.eql([
      'http://translate.google.com/translate_tts?ie=UTF-8&tl=fr&q=test&textlen=4&idx=0&total=1&client=tw-ob'
    ]);
  },
  'non-default language': function() {
    ...
    expect(urls).to.eql([
      'http://translate.google.com/translate_tts?ie=UTF-8&tl=en&q=test&textlen=4&idx=0&total=1&client=tw-ob'
    ]);
  },
  'slices at 100 characters': function() {
    ...
    expect(urls).to.eql([
      'http://translate.google.com/translate_tts?ie=UTF-8&tl=en&q=abc&textlen=3&idx=0&total=2&client=tw-ob',
      'http://translate.google.com/translate_tts?ie=UTF-8&tl=en&q=def&textlen=3&idx=1&total=2&client=tw-ob'
    ]);
